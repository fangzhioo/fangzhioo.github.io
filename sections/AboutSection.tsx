...
import satNaing from "../public/satnaing-profile.webp";
        ...
        <RoughNotationGroup>
          <div className="text-center">
            <RoughNotation
              ...
              show={isSecOnScreen}
            >
              <h2 className="section-heading">我是谁？</h2>
            </RoughNotation>
          </div>
          <div className="md:flex md:space-x-8">
            ...
            <div className="basis-3/5 lg:basis-1/2 xl:basis-2/5" ref={eduRef}>
              <p className="about-intro my-2">
                我有超过5年的网络开发经验，包括PC端、移动端、小程序等等方向都有涉足。<br />
                也有过一定的后端开发经历，对整个生态都有一定理解。<br />
                目前就职于中国杭州某企业的前端开发
              </p>
