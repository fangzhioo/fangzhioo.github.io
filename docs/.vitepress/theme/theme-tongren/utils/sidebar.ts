 ...
 * return empty array.
 */
export function getSidebar(sidebar: DefaultTheme.Sidebar | undefined, path: string): DefaultTheme.SidebarItem[] {
 ...
 */
export function getSidebarGroups(sidebar: DefaultTheme.SidebarItem[]): DefaultTheme.SidebarItem[] {
 ...
 */
export function hasActiveLink(path: string, items: DefaultTheme.SidebarItem | DefaultTheme.SidebarItem[]): boolean {
