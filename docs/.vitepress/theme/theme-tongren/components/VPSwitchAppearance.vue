...
import { APPEARANCE_KEY } from '../utils/shared'
...
function useAppearance() {
  ...
  let isDark = (site.value.appearance === 'dark' && userPreference == null) || (userPreference === 'auto' || userPreference == null ? query.matches : userPreference === 'dark')
...
<template>
  <label title="toggle dark mode">
    <VPSwitch class="VPSwitchAppearance" :aria-checked="checked" @click="toggle">
      <VPIconSun class="sun" />
